...
export const MONEY_PAGES: MoneyPage[] = [
  // ------------------------------------------------------------------ MONEY
  {
    ...
    faqs: [
      ...
      { q: "What does it cost?", a: "Flat monthly coverage, priced by geography rather than per opportunity, and scoped to your footprint. I quote it on a discovery call once I understand where you bid." },
    ],
    related: [
